...
<body>
	...
	<aside>
		...
		<div>
			<p align="center">Email :- pasindugunasekara889@gmail.com || Web :- www.bluebird.com || Phone :- +94 703179882 </p>
		</div>
	</aside>

	<div style="text-align: center; margin-top: 20px;">
		<button onclick="window.print();" class="btn btn-primary">Print Invoice</button>
		<a href="download_invoice.php?id=<?php echo $id; ?>" class="btn btn-success">Download Invoice</a>
	</div>
